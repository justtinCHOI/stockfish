...
public class QCash extends EntityPathBase<Cash> {
    ...
    private static final long serialVersionUID = -2020513939L;
    ...
    public final NumberPath<Long> doller = createNumber("doller", Long.class);
    ...
    public QCash(Class<? extends Cash> type, PathMetadata metadata, PathInits inits) {
        ...
        this.member = inits.isInitialized("member") ? new com.stockfish.stockfishserver.member.entity.QMember(forProperty("member"), inits.get("member")) : null;
    }

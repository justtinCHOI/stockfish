...
const StockOrder = ({ corpName }) => {
    ...
    const orderType = useSelector((state) => state.stockOrderType);
    const orderVolume = useSelector((state) => state.stockOrderVolume);
    const orderPrice = useSelector((state) => state.stockOrderPrice);
    const decisionWindow = useSelector((state) => state.decisionWindow);

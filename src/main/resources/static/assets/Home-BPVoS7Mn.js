import{p as t,r,j as e,a as c,b as j,L as v,I as b,c as y,F as I}from"./index-DYQX_Bvf.js";import{u as w}from"./useCustomLogin-D-c7Hfbh.js";const d=[{title:"미국 경제 성장 둔화",content:"미국 경제는 올해 첫 분기에 둔화되었습니다. 주요 지표에 따르면..."},{title:"일본 엔화 약세",content:"일본 엔화는 미국 달러 대비 약세를 보였습니다. 경제적 우려가..."},{title:"독일 주식 시장 사상 최고치",content:"독일 주식 시장이 오늘 사상 최고치를 기록했습니다. 투자자들의 낙관적인 전망..."},{title:"중국 경제 회복",content:"중국 경제가 팬데믹 이후 빠르게 회복하고 있습니다. 전문가들은..."},{title:"영국 브렉시트 영향",content:"영국의 브렉시트가 경제에 미치는 영향이 점차 명확해지고 있습니다..."},{title:"프랑스 경제 성장",content:"프랑스 경제는 올해 강한 성장세를 보였습니다. 소비 증가와 함께..."},{title:"캐나다 경제 회복",content:"캐나다 경제는 팬데믹 이후 회복세를 보이고 있습니다. 주요 지표들이..."}],z=()=>{const[i,s]=r.useState(0);return r.useEffect(()=>{const n=setInterval(()=>{s(o=>(o+1)%d.length)},4e3);return()=>clearInterval(n)},[]),e.jsxs(k,{children:[e.jsx($,{children:"🛫 국가별 뉴스"}),e.jsx(S,{children:d.map((n,o)=>e.jsxs(L,{$active:o===i?"true":"false",children:[e.jsx("h3",{children:n.title}),e.jsx("p",{children:n.content}),e.jsxs(q,{children:["더보기 ",e.jsx(c,{})]})]},o))})]})},k=t.section`
    margin-bottom: 20px;
`,$=t.h2`
    font-size: 1.2rem;
    margin-bottom: 10px;
